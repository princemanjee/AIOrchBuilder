    ...
    return (
        <main className="page-wrapper fade-in-up">
            <header className="page-header">
                ...
                <h1 className="page-title">Resume Workspace</h1>
                <p className="page-subtitle">Sandbox environment for the Resume data models and interactive tools.</p>
            </header>
